document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateWeatherInfo() {
        ...
        switch (weatherData.weatherMain) {
            case "Clouds":
                weatherIcon.src = staticUrl + 'app/img/cloud.png';
                break;
            case "Clear":
                weatherIcon.src = staticUrl + 'app/img/clear.png';
                break;
            case "Rain":
                weatherIcon.src = staticUrl + 'app/img/rain.png';
                break;
            case "Mist":
                weatherIcon.src = staticUrl + 'app/img/mist.png';
                break;
            case "Snow":
                weatherIcon.src = staticUrl + 'app/img/snow.png';
                break;
            default:
                weatherIcon.src = "";
                break;
